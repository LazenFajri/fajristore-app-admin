      ...
      <div class="mx-auto w-full overflow-hidden rounded-lg bg-gray-100 shadow-xl sm:max-w-sm">
        <div class="relative p-5">
          <div class="text-center">
            ...
            <div>
              <h3 class="text-lg font-medium text-secondary-900">Hapus {productInfo?.title}</h3>
              <div class="mt-2 text-sm text-secondary-500">Apakah Anda yakin ingin menghapus produk ini? Tindakan ini tidak bisa dibatalkan.</div>
            </div>
          </div>
