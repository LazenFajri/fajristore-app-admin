        ...
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-md leading-6 text-gray-600">
              Informasi ini hanya akan ditampilkan kepada Anda.
            </p>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                ...
                <p className="mt-3 text-md leading-6 text-gray-600">Anda adalah salah satu administrator dasbor ini.</p>
              </div>
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-md leading-6 text-gray-600">Anda hanya dapat melihat informasi Anda, Anda tidak dapat mengeditnya.</p>
